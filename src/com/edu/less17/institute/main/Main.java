...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		//выводим данные о курсе1 в консоль
		System.out.println(service.getCourseInfo(course1));
		
		//выводим данные о курсе2 в консоль
		System.out.println(service.getCourseInfo(course2));
		
		//выводим список студентов по алфавиту
		System.out.println(service.getStudentsByAlphabet(course2));
				
		//выводим списов студентов по средней оценке
